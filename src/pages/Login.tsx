    ...
    >
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-normal text-[#1D1D1F] tracking-tight mb-2">Edullent</h1>
          <p className="text-[#64748b] font-normal uppercase tracking-[0.2em] text-xs">Parent Portal</p>
        </div>
        ...
        <div className="bg-white rounded-[2.5rem] p-10 shadow-2xl shadow-slate-200/60 border border-slate-100 relative overflow-hidden">
          ...
          <div className="mb-10 text-center">
            <h2 className="text-2xl font-normal text-[#1D1D1F] mb-2">Parent Login</h2>
            <p className="text-slate-500 font-normal">Access your child's academic records</p>
          </div>
          ...
          >
            {isLoggingIn ? (
              ...
              <>
                ...
                <span className="text-lg font-normal text-[#1D1D1F]">Sign in with Google</span>
              </>
            )}
          </button>

          <div className="mt-10 pt-10 border-t border-slate-50 text-center">
            <p className="text-[12px] font-normal text-slate-400 uppercase tracking-widest leading-loose">
              Only registered parents can access this portal.<br/>Use your registered Google account.
            </p>
          </div>
        </div>

        <p className="text-center mt-8 text-[12px] font-normal text-slate-400 uppercase tracking-widest">
