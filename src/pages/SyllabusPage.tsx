...
const SyllabusPage = () => {
  ...
  if (isMobile) {
    ...
    const themeMap: Record<DocType, {
      ...
      pdf: {
        icoBg: "linear-gradient(135deg, #FF3B30, #FF5E55)",
        icoShadow: "0 4px 14px rgba(255,59,48,0.30)",
        tagBg: "rgba(255,59,48,0.08)", tagColor: RED, tagBorder: "rgba(255,59,48,0.18)",
        tagLabel: "PDF", viewLabel: "View PDF",
      },
      doc: {
        icoBg: `linear-gradient(135deg, ${B1}, #5BA9FF)`,
        icoShadow: "0 4px 14px rgba(10,132,255,0.28)",
        tagBg: "rgba(10,132,255,0.10)", tagColor: B1, tagBorder: "rgba(10,132,255,0.20)",
        tagLabel: "DOC", viewLabel: "Open Document",
      },
      img: {
        icoBg: `linear-gradient(135deg, ${GREEN}, #34C759)`,
        icoShadow: "0 4px 14px rgba(52,199,89,0.26)",
        tagBg: "rgba(52,199,89,0.10)", tagColor: "#248A3D", tagBorder: "rgba(52,199,89,0.22)",
        tagLabel: "IMG", viewLabel: "View Image",
      },
      xls: {
        icoBg: `linear-gradient(135deg, ${ORANGE}, #FFCC00)`,
        icoShadow: "0 4px 14px rgba(255,149,0,0.26)",
        tagBg: "rgba(255,149,0,0.08)", tagColor: "#86310C", tagBorder: "rgba(255,149,0,0.18)",
      ...
      return (
        <div data-sfpro className="animate-in fade-in duration-500 -mx-3 -mt-3 md:mx-0 md:mt-0"
          ...
          <div className="flex items-start justify-between px-[24px] pt-[16px]">
            <div>
              <div className="text-[26px] font-bold mb-[4px]" style={{ color: T1, letterSpacing: "-0.7px" }}>Class Documents</div>
    ...
    return (
      <div data-sfpro className="animate-in fade-in duration-500 -mx-3 -mt-3 md:mx-0 md:mt-0"
        ...
        <div className="flex items-start justify-between px-[24px] pt-[16px]">
          ...
          {docs.length > 0 && (
            <div className="px-3 py-[4px] rounded-full text-[10px] font-bold tracking-[0.04em] text-white whitespace-nowrap mt-1 shrink-0"
        ...
        <div className="mx-5 mt-4 relative">
          <div className="absolute left-[16px] top-1/2 -translate-y-1/2 pointer-events-none">
            <Search className="w-4 h-4" style={{ color: "rgba(10,132,255,0.40)" }} strokeWidth={2.2} />
          </div>
          <input
            type="text"
            value={searchQuery}
            ...
            className="w-full py-[12px] pr-4 pl-10 rounded-[17px] text-[14px] font-normal outline-none bg-white"
            style={{
          ...
          {FILTERS.map(f => {
            ...
            return (
              <button
                ...
                className="px-[16px] py-[8px] rounded-full text-[11px] font-bold flex-shrink-0 transition-transform active:scale-[0.94]"
                style={{
                  ...
                  boxShadow: isAct ? "0 3px 12px rgba(10,132,255,0.30)" : SH,
        ...
        {/* ── Section label ── */}
        <div className="px-[24px] pt-[16px] text-[9px] font-bold uppercase tracking-[0.10em] flex items-center gap-2"
          style={{ color: T4 }}>
          ...
          mobileFiltered.map((doc: any) => {
            ...
            return (
              <div
                ...
                className="mx-5 mt-[16px] bg-white rounded-[24px] p-5 relative overflow-hidden cursor-pointer active:scale-[0.97] transition-transform focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0A84FF]/40"
                ...
                <div className="flex items-start gap-[16px] mb-4 relative z-10">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-[16px] font-bold mb-[4px] leading-[1.3]" style={{ color: T1, letterSpacing: "-0.3px" }}>
                      {doc.title || "Untitled Document"}
                    </div>
                    {doc.fileName && (
                      <div className="text-[11px] font-medium truncate max-w-full mb-[4px]" style={{ color: T3, letterSpacing: "-0.1px" }}>
                        {doc.fileName}
                      </div>
                    )}
                    <div className="flex items-center gap-[12px] flex-wrap">
                      {doc.fileSize ? (
                        <div className="px-[8px] py-[4px] rounded-full text-[10px] font-bold tracking-[0.02em]"
                ...
                <div className="flex gap-[12px] relative z-10">
                  ...
                  <a
                    ...
                    <Download className="w-4 h-4" style={{ color: "rgba(10,132,255,0.7)" }} strokeWidth={2.2} />
                  </a>
                </div>
              </div>
            );
        ...
        {!loading && docs.length > 0 && (
          <div className="mx-5 mt-[16px] rounded-[22px] px-5 py-[16px] relative overflow-hidden"
            style={{
            ...
            <div className="absolute -top-[32px] -right-[24px] w-[160px] h-[160px] rounded-full pointer-events-none"
              style={{ background: "radial-gradient(circle, rgba(255,255,255,0.12) 0%, transparent 65%)" }} />
            <div className="absolute inset-0 pointer-events-none" style={{
              backgroundImage: "linear-gradient(rgba(255,255,255,0.014) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.014) 1px, transparent 1px)",
              backgroundSize: "24px 24px"
            }} />
            <div className="text-[9px] font-bold uppercase tracking-[0.12em] mb-[12px] relative z-10" style={{ color: "rgba(255,255,255,0.48)" }}>
              Document Library
            </div>
  ...
  const themeMapD: Record<DocTypeD, { icoBg: string; icoShadow: string; tagBg: string; tagColor: string; tagBorder: string; tagLabel: string; viewLabel: string; }> = {
    pdf:   { icoBg: "linear-gradient(135deg, #FF3B30, #FF5E55)", icoShadow: "0 4px 14px rgba(255,59,48,0.30)", tagBg: "rgba(255,59,48,0.08)", tagColor: RED, tagBorder: "rgba(255,59,48,0.18)", tagLabel: "PDF", viewLabel: "View PDF" },
    doc:   { icoBg: `linear-gradient(135deg, ${B1}, #5BA9FF)`, icoShadow: "0 4px 14px rgba(10,132,255,0.28)", tagBg: "rgba(10,132,255,0.10)", tagColor: B1, tagBorder: "rgba(10,132,255,0.20)", tagLabel: "DOC", viewLabel: "Open Document" },
    img:   { icoBg: `linear-gradient(135deg, ${GREEN}, #34C759)`, icoShadow: "0 4px 14px rgba(52,199,89,0.26)", tagBg: "rgba(52,199,89,0.10)", tagColor: "#248A3D", tagBorder: "rgba(52,199,89,0.22)", tagLabel: "IMG", viewLabel: "View Image" },
    xls:   { icoBg: `linear-gradient(135deg, ${ORANGE}, #FFCC00)`, icoShadow: "0 4px 14px rgba(255,149,0,0.26)", tagBg: "rgba(255,149,0,0.08)", tagColor: "#86310C", tagBorder: "rgba(255,149,0,0.18)", tagLabel: "XLS", viewLabel: "Open Sheet" },
    other: { icoBg: `linear-gradient(135deg, ${B1}, #5BA9FF)`, icoShadow: "0 4px 14px rgba(10,132,255,0.28)", tagBg: "rgba(10,132,255,0.10)", tagColor: B1, tagBorder: "rgba(10,132,255,0.20)", tagLabel: "FILE", viewLabel: "Open File" },
  };
    ...
    <div data-sfpro className="animate-in fade-in duration-500 -m-4 sm:-m-6 md:-m-8 min-h-[calc(100vh-64px)]"
      ...
      <div className="w-full px-6 pt-8 pb-10">
        ...
        <div className="flex items-start justify-between gap-6 flex-wrap mb-5">
          ...
          {docs.length > 0 && (
            <div className="px-4 py-[12px] rounded-full text-[13px] font-bold tracking-[0.02em] text-white whitespace-nowrap"
              style={{ background: `linear-gradient(135deg, ${B1}, ${B2})`, boxShadow: "0 3px 10px rgba(10,132,255,0.28)" }}>
        ...
        <div className="flex items-center gap-3 mb-5 flex-wrap">
          <div className="flex-1 min-w-[280px] relative">
            <div className="absolute left-[16px] top-1/2 -translate-y-1/2 pointer-events-none">
              <Search className="w-[17px] h-[17px]" style={{ color: "rgba(10,132,255,0.40)" }} strokeWidth={2.2} />
            </div>
            <input
              type="text"
              value={searchQuery}
              onChange={e => setSearchQuery(e.target.value)}
              placeholder="Search by title, file name, or teacher..."
              className="w-full py-[16px] pr-4 pl-10 rounded-[16px] text-[14px] font-normal outline-none bg-white"
              style={{
                border: "0.5px solid rgba(10,132,255,0.12)",
                color: T1,
                letterSpacing: "-0.1px",
            ...
            {FILTERS_D.map(f => {
              ...
              return (
                <button
                  key={f.key}
                  onClick={() => setTypeFilter(f.key)}
                  className="px-4 py-[12px] rounded-[16px] text-[12px] font-bold flex-shrink-0 transition-transform hover:scale-[1.03]"
                  style={{
                    background: isAct ? `linear-gradient(135deg, ${B1}, ${B2})` : "#FFFFFF",
                    color: isAct ? "#fff" : T3,
                    border: isAct ? "0.5px solid transparent" : "0.5px solid rgba(10,132,255,0.12)",
            ...
            {finalFilteredD.map((doc: any) => {
              ...
              return (
                <div
                  ...
                  onClick={() => handleView(doc.fileUrl)}
                  onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); handleView(doc.fileUrl); } }}
                  className="bg-white rounded-[24px] p-6 relative overflow-hidden cursor-pointer transition-all duration-200 hover:-translate-y-1.5 hover:shadow-2xl hover:scale-[1.015] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0A84FF]/40"
                  style={{ boxShadow: SH_LG, border: "0.5px solid rgba(10,132,255,0.10)" }}>
                  ...
                  <div className="flex gap-[12px] relative z-10">
                    ...
                    <a
                      ...
                      <Download className="w-[17px] h-[17px]" style={{ color: "rgba(10,132,255,0.7)" }} strokeWidth={2.2} />
                    </a>
                  </div>
                </div>
              );
        ...
        {/* ── Summary Dark Card ── */}
        {!loading && docs.length > 0 && (
          <div className="mt-5 rounded-[24px] px-8 py-6 relative overflow-hidden transition-all duration-200 hover:-translate-y-1 hover:shadow-2xl"
            style={{
              background: "linear-gradient(140deg, #0A84FF 0%, #0A84FF 48%, #0A84FF 100%)",
              boxShadow: "0 8px 28px rgba(0,51,204,0.32), 0 0 0 0.5px rgba(255,255,255,0.14)",
            }}>
            <div className="absolute -top-[45px] -right-[32px] w-[220px] h-[220px] rounded-full pointer-events-none"
              style={{ background: "radial-gradient(circle, rgba(255,255,255,0.12) 0%, transparent 65%)" }} />
            <div className="absolute inset-0 pointer-events-none" style={{
              backgroundImage: "linear-gradient(rgba(255,255,255,0.014) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.014) 1px, transparent 1px)",
              backgroundSize: "24px 24px"
