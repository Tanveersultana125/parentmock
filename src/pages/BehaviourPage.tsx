        ...
        {loading ? (
          ...
          <>
            ...
            <div className="px-[24px] pt-5">
              <div className="text-[9px] font-bold uppercase tracking-[0.12em] mb-1 flex items-center gap-[8px]" style={{ color: T4 }}>
            ...
            <div className="mx-5 mt-[16px] bg-white rounded-[26px] p-[24px] relative overflow-hidden"
              ...
              <div className="text-[17px] font-bold mb-[4px] relative z-10" style={{ color: T1, letterSpacing: "-0.3px" }}>
              ...
              <div className="flex items-center gap-4 mb-4 relative z-10">
                <div className="flex flex-col">
                  ...
                  <div className="text-[11px] font-bold uppercase tracking-[0.08em] mt-[4px]" style={{ color: T4 }}>Out of 5</div>
                </div>
                  ...
                  return (
                    <div key={note.id || idx}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-[10px] font-semibold flex items-center gap-[4px]" style={{ color: T4 }}>
            ...
            {trendData.length > 1 && (
              <div className="mx-5 mt-3 bg-white rounded-[24px] p-5"
                ...
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="px-[12px] py-1 rounded-full text-[11px] font-bold"
          ...
          <>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-[12px]">
                <div className="px-[16px] py-[8px] rounded-full text-[12px] font-bold flex items-center gap-[8px]"
                    ...
                    {positiveNotes.slice(0, 6).map((note, idx) => {
                      ...
                      return (
                        <div key={note.id || idx}
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="text-[13px] font-bold mb-[4px]" style={{ color: T1, letterSpacing: "-0.1px" }}>
                              {note.content || "Great behaviour"}
                            </div>
                          ...
                          <div className="px-[12px] py-[4px] rounded-full text-[10px] font-bold shrink-0"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div className="lg:col-span-2 bg-white rounded-[22px] p-6"
                ...
                <div className="flex items-center justify-between mb-5">
                  ...
                  <div className="px-[12px] py-[4px] rounded-full text-[12px] font-bold"
